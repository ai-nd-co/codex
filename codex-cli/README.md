...
<p align="center"><code>npm i -g @ai-nd-co/codex</code></p>
...
npm install -g @ai-nd-co/codex
# or
yarn global add @ai-nd-co/codex
# or
bun install -g @ai-nd-co/codex
# or
...
You may need to upgrade to a more recent version with: `npm i -g @ai-nd-co/codex@latest`
