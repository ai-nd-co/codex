...
# Fork platform packages have distinct names so npm can resolve them normally.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Limit the root package to selected platform dependencies.",
    )
...
def main() -> int:
    ...
    selected_platform_packages = list(
        dict.fromkeys(
            args.platform_packages
            or [name for name in PACKAGE_EXPANSIONS["codex"] if name != "codex"]
        )
    )
