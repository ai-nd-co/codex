...
pub enum UpdateAction {
    /// Update via `npm install -g @ai-nd-co/codex@latest`.
    NpmGlobalLatest,
    /// Update via `bun install -g @ai-nd-co/codex@latest`.
    BunGlobalLatest,
    /// Update via `pnpm add -g @ai-nd-co/codex@latest`.
    PnpmGlobalLatest,
...
impl UpdateAction {
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            UpdateAction::NpmGlobalLatest => ("npm", &["install", "-g", "@ai-nd-co/codex"]),
            UpdateAction::BunGlobalLatest => ("bun", &["install", "-g", "@ai-nd-co/codex"]),
            UpdateAction::PnpmGlobalLatest => ("pnpm", &["add", "-g", "@ai-nd-co/codex"]),
