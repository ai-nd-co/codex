...
"#;
    ...
    fn test_precedence_fixture_with_o3_profile() -> std::io::Result<()> {
        ...
        assert_eq!(
            Config {
                ...
                shell_path_override: o3_profile_config.shell_path_override.clone(),
    ...
    fn test_precedence_fixture_with_gpt3_profile() -> std::io::Result<()> {
        ...
        let expected_gpt3_profile_config = Config {
            ...
            forced_auto_mode_downgraded_on_windows: false,
            shell_environment_policy: ShellEnvironmentPolicy::default(),
            shell_path_override: gpt3_profile_config.shell_path_override.clone(),
            user_instructions: None,
            notify: None,
            cwd: fixture.cwd(),
            cli_auth_credentials_store_mode: Default::default(),
    ...
    fn test_precedence_fixture_with_zdr_profile() -> std::io::Result<()> {
        ...
        let expected_zdr_profile_config = Config {
            ...
            forced_auto_mode_downgraded_on_windows: false,
            shell_environment_policy: ShellEnvironmentPolicy::default(),
            shell_path_override: zdr_profile_config.shell_path_override.clone(),
            user_instructions: None,
            notify: None,
            cwd: fixture.cwd(),
            cli_auth_credentials_store_mode: Default::default(),
    ...
    fn test_precedence_fixture_with_gpt5_profile() -> std::io::Result<()> {
        ...
        let expected_gpt5_profile_config = Config {
            ...
            forced_auto_mode_downgraded_on_windows: false,
            shell_environment_policy: ShellEnvironmentPolicy::default(),
            shell_path_override: gpt5_profile_config.shell_path_override.clone(),
            user_instructions: None,
            notify: None,
            cwd: fixture.cwd(),
            cli_auth_credentials_store_mode: Default::default(),
