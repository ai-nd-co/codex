...
const DEFAULT_MULTI_AGENT_V2_AUTOMATIC_COMPLETION_USAGE_HINT_TEXT: &str = "Worker progress and terminal results arrive automatically and wake you when idle. Messages queue while you are busy; use `list_agents` to inspect current state.";
